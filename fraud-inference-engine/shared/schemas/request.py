...
class FraudPredictionRequest(BaseModel):
    ...
    day_of_week: int = Field(ge=1, le=7, default=1)
    merchant_category: int = Field(ge=0, le=7, default=7)
    card_type: int = Field(ge=0, le=3, default=3)
    distinct_merchant_count_1hour: int = Field(ge=0, default=0)
