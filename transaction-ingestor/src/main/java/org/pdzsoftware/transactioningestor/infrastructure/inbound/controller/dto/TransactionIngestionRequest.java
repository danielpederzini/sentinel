...
public record TransactionIngestionRequest(
        @Schema(description = "Client-supplied unique transaction identifier; generated if omitted", example = "tx-000042")
        String transactionId,
        @Schema(description = "Identifier of the user who initiated the transaction", example = "user-000042")
        @NotBlank String userId,
        @Schema(description = "Identifier of the card used", example = "card-000042")
        @NotBlank String cardId,
        @Schema(description = "Identifier of the merchant", example = "merchant-0042")
        @NotBlank String merchantId,
        @Schema(description = "Identifier of the device used, when available", example = "device-000042")
        String deviceId,
        ...
        String ipAddress,
        @Schema(description = "Timestamp when the transaction was created; must not be in the future", example = "2026-05-28T14:30:00")
